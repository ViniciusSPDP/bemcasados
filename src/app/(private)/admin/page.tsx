...
import {
  ...
  Clock,
  ArrowDownCircle,
  MailCheck // Importando ícone de e-mail
} from "lucide-react";
            ...
            <div className="flex items-center gap-4 w-full md:w-auto">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 flex items-center gap-1">
                  ...
                  {isApproved ? 'Conta Verificada' : 'Aprovação Pendente no Asaas'}
                </p>
              </div>
            </div>
        ...
        <Tabs defaultValue="dashboard" className="w-full">
          <div className="flex justify-center md:justify-start mb-6">
            <TabsList className="bg-white border border-gray-200 p-1 rounded-xl h-auto shadow-sm">
              ...
              <TabsTrigger value="kyc" className="px-6 py-2.5 rounded-lg data-[state=active]:bg-rose-600 data-[state=active]:text-white transition-all flex items-center gap-2 font-bold"><FileCheck size={18}/> Conta e Saques</TabsTrigger>
            </TabsList>
          </div>
          ...
          <TabsContent value="dashboard" className="space-y-8 animate-in fade-in duration-500">
            {!isApproved && (
              <div className="bg-amber-50 border border-amber-200 p-4 rounded-2xl flex items-center gap-3 shadow-sm font-bold">
                ...
                <p className="text-xs text-amber-700 uppercase tracking-tight">Verificação Pendente: Siga as instruções enviadas por e-mail pelo Asaas para liberar saques.</p>
              </div>
            )}
              ...
              <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm text-center">
                {isApproved ? (
                  ...
                  <div className="space-y-6">
                    ...
                    <h2 className="text-xl font-bold text-gray-900 uppercase tracking-tight">Ativação da Carteira</h2>
                    
                    <div className="text-left space-y-4 bg-gray-50 p-6 rounded-2xl border border-gray-100">
                        <p className="text-sm text-gray-600 leading-relaxed">
                            O Asaas enviou um e-mail para o endereço cadastrado com as instruções de acesso ao painel oficial.
                        </p>
                        <ul className="text-xs text-gray-500 space-y-2 list-disc pl-4">
                            <li>Procure por um e-mail com o assunto &quot;Acesse sua conta&quot; ou &quot;Redefinição de senha&quot;.</li>
                            <li>Defina sua senha e acesse o painel do Asaas.</li>
                            <li>Envie a Selfie e os documentos solicitados diretamente por lá.</li>
                        </ul>
                    </div>
                    ...
                    <div className="pt-4">
                        ...
                        <p className="text-[10px] text-gray-400 mt-3 italic">
                            O botão acima buscará o link de envio apenas se o Asaas permitir o acesso externo. 
                            Caso contrário, utilize o painel oficial deles.
                        </p>
                    </div>
                  </div>
                )}
